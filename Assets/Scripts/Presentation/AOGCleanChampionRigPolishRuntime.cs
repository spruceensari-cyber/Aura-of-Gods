...
public class AOGCleanChampionRigPolishRuntime : MonoBehaviour
{
    ...
    private static void Build(AOGTeamMemberIdentity member)
    {
        ...
        if (model == null || model.Find("Clean_Humanoid_Rig") != null) return;
        ...
        BuildWeaponIdentity(rig,member.championId,energy);
    ...
    private static void BuildWeaponIdentity(Transform root,string id,Material energy)
    {
        ...
        {
            GameObject upper = CreatePart(root,PrimitiveType.Cube,"Bow_Upper",new Vector3(0.76f,1.44f,0.12f),new Vector3(0.10f,0.72f,0.10f),energy);
            upper.transform.localRotation = Quaternion.Euler(0f,0f,28f);
            GameObject lower = CreatePart(root,PrimitiveType.Cube,"Bow_Lower",new Vector3(0.76f,0.80f,0.12f),new Vector3(0.10f,0.72f,0.10f),energy);
